...
export default async function AdminSakanaCategoryListPage() {
  const cookie = (await cookies()).toString();
  const categories = await apiFetch<AdminSakanaCategory[]>(
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Link
          href="/admin/sakana/categories/new"
            ...
            {categories.map((c) => (
              ...
              >
                ...
                <td className="px-5 py-4">
                  <Link
                    href={`/admin/sakana/categories/${c.id}`}
